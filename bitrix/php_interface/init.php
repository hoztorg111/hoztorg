<?
// пїЅпїЅпїЅпїЅ /bitrix/php_interface/init.php
...
AddMessage2Log('error: add new BRAND ('.$el->LAST_ERROR.') '.print_r($arBrandFields, 1), '');
echo $el->LAST_ERROR;
}
}
}
...
function OnSuccessCatalogImport1C($t){
AddMessage2Log('OnSuccessCatalogImport1C started', '');
...
AddMessage2Log('OnSuccessCatalogImport1C finished', '');
}
