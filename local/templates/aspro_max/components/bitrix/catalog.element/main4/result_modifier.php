...
$arResult['PROPERTIES']['CML2_ARTICLE']['VALUE'] = preg_replace('/([0-9]+) ([0-9]+) ([a-zA-Zа-яА-ЯЁё]+)$/', '$2', $arResult['PROPERTIES']['CML2_ARTICLE']['VALUE']);
$arResult['CML2_ARTICLE']['VALUE'] = preg_replace('/([0-9]+) ([0-9]+) ([a-zA-Zа-яА-ЯЁё]+)$/', '$2', $arResult['CML2_ARTICLE']['VALUE']);
$arResult['DISPLAY_PROPERTIES']['CML2_ARTICLE']['VALUE'] = preg_replace('/([0-9]+) ([0-9]+) ([a-zA-Zа-яА-ЯЁё]+)$/', '$2', $arResult['DISPLAY_PROPERTIES']['CML2_ARTICLE']['VALUE']);
...
if(strlen($arResult["DISPLAY_PROPERTIES"]["BRAND"]["VALUE"]) && $arResult["PROPERTIES"]["BRAND"]["LINK_IBLOCK_ID"]){
	$arBrand = CMaxCache::CIBLockElement_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arResult["PROPERTIES"]["BRAND"]["LINK_IBLOCK_ID"]))), array("IBLOCK_ID" => $arResult["PROPERTIES"]["BRAND"]["LINK_IBLOCK_ID"], "ACTIVE"=>"Y", "ID" => $arResult["DISPLAY_PROPERTIES"]["BRAND"]["VALUE"], '!PROPERTY_SHOW_PUBLIC_PART' => false));
	if($arBrand){
