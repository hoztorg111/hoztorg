...
<?
use App\AsproMax\CCustomMaxItem;
?>
											...
											<div class="cost prices detail">
												...
												<?else:?>
													...
													<?elseif($arResult["PRICES"]):?>
														<?CCustomMaxItem::showItemPrices($arParams, $arResult["PRICES"], $strMeasure, $min_price_id, ($arParams["SHOW_DISCOUNT_PERCENT_NUMBER"] == "Y" ? "N" : "Y"));?>
													<?endif;?>
												<?endif;?>
											</div>
