						...
						<div class="form_footer">
							...
							<div class="buttons clearfix">
								...
								<?else:?>
									...
									<!--noindex--><a href="<?=$arResult['AUTH_REGISTER_URL'];?>" rel="nofollow" class="btn btn-default btn-lg pull-right register" tabindex="6"><?=GetMessage('AUTH_REGISTER_NEW')?></a><!--/noindex-->
								<?endif;?>
