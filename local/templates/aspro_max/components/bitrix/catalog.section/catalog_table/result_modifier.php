...
if (!empty($arResult['ITEMS'])){
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		$arItem['PROPERTIES']['CML2_ARTICLE']['VALUE'] = preg_replace('/([0-9]+) ([0-9]+) ([a-zA-Zа-яА-ЯЁё]+)$/', '$2', $arItem['PROPERTIES']['CML2_ARTICLE']['VALUE']);
		$arResult['ITEMS'][$key]['PROPERTIES']['CML2_ARTICLE']['VALUE'] = preg_replace('/([0-9]+) ([0-9]+) ([a-zA-Zа-яА-ЯЁё]+)$/', '$2', $arResult['ITEMS'][$key]['PROPERTIES']['CML2_ARTICLE']['VALUE']);
		$arItem['DISPLAY_PROPERTIES']['CML2_ARTICLE']['VALUE'] = preg_replace('/([0-9]+) ([0-9]+) ([a-zA-Zа-яА-ЯЁё]+)$/', '$2', $arItem['DISPLAY_PROPERTIES']['CML2_ARTICLE']['VALUE']);
		$arResult['ITEMS'][$key]['DISPLAY_PROPERTIES']['CML2_ARTICLE']['VALUE'] = preg_replace('/([0-9]+) ([0-9]+) ([a-zA-Zа-яА-ЯЁё]+)$/', '$2', $arResult['ITEMS'][$key]['DISPLAY_PROPERTIES']['CML2_ARTICLE']['VALUE']);
